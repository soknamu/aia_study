...
for d in data_list:
    ...
    print(x_pf.shape)
    x_train, x_test, y_train, y_test = train_test_split(x_pf, y, train_size = 0.7, shuffle = True, random_state = 1234)
    for s in scaler_list:
        ...
        for m in model_list:
            ...
            model = StackingClassifier(estimators = models, final_estimator=(DecisionTreeClassifier()))
