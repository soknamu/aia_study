...
model = LGBMClassifier(random_state=2053)
#model = XGBClassifier(random_state=2035,tree_method='gpu_hist', gpu_id=0, predictor = 'gpu_predictor')
...
param_grid = {'n_estimators' : [10000],
    'learning_rate': [0.01, 0.1, 0.005,0.00001],
    'max_depth': [3, 4],
}
...
submission.to_csv('c:/study/_save/dacon_airplane/서브밋535325321.csv', index=True)
