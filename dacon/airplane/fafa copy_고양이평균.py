...
parameters = {'n_estimators' : [30],  # epochs 역할
              'learning_rate' : [0.015], # 학습률의 크기 너무 크면 최적의 로스값을 못잡고 너무 작으면 최소점에 가지도못하고 학습이끝남.
...
submission.to_csv('c:/study/_save/dacon_airplane/1234submission.csv')