...
xy_train = train_datagen2.flow(x_train, y_train, 
                               batch_size=128, 
                               shuffle=True)
np.save(save_path + 'keras58_1_mnist_x_train.npy', arr = x_train)
np.save(save_path + 'keras58_1_mnist_x_test.npy', arr = x_test)
np.save(save_path + 'keras58_1_mnist_y_train.npy', arr = y_train)
np.save(save_path + 'keras58_1_mnist_y_test.npy', arr = y_test)