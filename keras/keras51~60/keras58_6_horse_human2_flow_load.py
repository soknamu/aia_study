...
horse_human_x_train = np.load(save_path + 'keras58_human_horse_x_train.npy')
horse_human_x_test = np.load(save_path + 'keras58_human_horse_x_test.npy')
horse_human_y_train = np.load(save_path + 'keras58_human_horse_y_train.npy')
horse_human_y_test = np.load(save_path + 'keras58_human_horse_y_test.npy')
