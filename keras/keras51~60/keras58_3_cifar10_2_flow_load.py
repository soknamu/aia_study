...
x_train = np.load(save_path + 'keras58_1_cifar10_x_train.npy')
x_test = np.load(save_path + 'keras58_1_cifar10_x_test.npy')
y_train = np.load(save_path + 'keras58_1_cifar10_y_train.npy')
y_test = np.load(save_path + 'keras58_1_cifar10_y_test.npy')
