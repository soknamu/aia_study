...
hist = model.fit(dog_breed_x_train, dog_breed_y_train, epochs = 5000, validation_data=(dog_breed_x_test, dog_breed_y_test),
                 callbacks = [es])
...
# loss :  [1.7171528339385986, 0.43042072653770447]
# acc :  0.43042071197411