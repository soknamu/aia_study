...
men_women_x_train = np.load(save_path + 'keras56_men_women_x_train.npy')
men_women_x_test = np.load(save_path + 'keras56_men_women_x_test.npy')
men_women_y_train = np.load(save_path + 'keras56_men_women_y_train.npy')
men_women_y_test = np.load(save_path + 'keras56_men_women_y_test.npy')
