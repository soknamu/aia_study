...
# 2. 모델구성
model = Sequential()
model.add(Conv2D(8, 2, padding='same', strides=1, input_shape=(32, 32, 3)))
...
hist = model.fit(x_train, y_train, epochs=1000, batch_size=5000, verbose=1, callbacks=[es], validation_split=0.2)
