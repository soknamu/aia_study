...
import time
path = 'd:/study_data/_data/young_old/'
...
print(young_old_x_train.shape) #(598, 150, 150, 3)
print(young_old_x_test.shape)  #(257, 150, 150, 3)
print(young_old_y_train.shape) #(598, 6)
print(young_old_y_test.shape)  #(257, 6)
